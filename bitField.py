class bf(object):
    ...
    def __init__(self, value, width=None):
        ...
        if isinstance(value, int):
            ...
            raise TypeError('unsupported type for Bitfield: {type(value)}')
        self.width = width
    ...
    def __getitem__(self, key):
        ...
        if isinstance(key, int):
            ...
            raise TypeError('unsupported index type: {type(key)}')
    ...
    def append(self, other):
        ...
        if not isinstance(other, Bitfield):
            raise TypeError('cannot append {type(other)} to Bitfield')
        temp = other << len(self)
        self |= temp
    ...
    def __add__(self, other):
        if isinstance(other, int):
            ...
            raise TypeError('unsupported operand type(s) for +: Bitfield and {type(other)}')
    ...
    def __rsub__(self, other):
        if isinstance(other, int):
            ...
            raise TypeError('unsupported operand type(s) for -: {type(other)} and Bitfield')
